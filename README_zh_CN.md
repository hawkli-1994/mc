...
```
go get -d github.com/hawkli-1994/mc
cd ${GOPATH}/src/github.com/hawkli-1994/mc
make
```
...
## 贡献
请遵守MinIO[贡献者指南](https://github.com/hawkli-1994/mc/blob/master/docs/zh_CN/CONTRIBUTING.md)
