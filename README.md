...
```sh
go install github.com/hawkli-1994/mc@latest
```
...
Please follow MinIO [Contributor's Guide](https://github.com/hawkli-1994/mc/blob/master/CONTRIBUTING.md)

## License
Use of `mc` is governed by the GNU AGPLv3 license that can be found in the [LICENSE](https://github.com/hawkli-1994/mc/blob/master/LICENSE) file.
