...
There has been some amount of [requests](https://github.com/hawkli-1994/mc/issues?q=is%3Aissue+midnight+commander+is%3Aclosed) on renaming this project to avoid the conflict with Midnight Commander for Unix distributions. We struggled with this, it is harder to find a name sweeter and shorter than `mc` for MinIO Client.
...
Package managers are free to choose a different name if they like. One such solution [pointed out](https://github.com/hawkli-1994/mc/issues/873#issuecomment-267583013) by one of our community members.
